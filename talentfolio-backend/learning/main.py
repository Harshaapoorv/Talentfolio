...
@app.post("/user-model", response_model=UserResponse)
def create_user_model(user: UserCreate):
    fake_user_id = 1  # In a real application, this would be generated by the database
